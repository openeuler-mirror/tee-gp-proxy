...
# KEYPEM=$HOME/.gpp/certs/ca_key.pem
# PUBPEM=$HOME/.gpp/certs/ca_pubkey.pem
# CRTPEM=$HOME/.gpp/certs/ca_crt.pem
# MSGTXT=$HOME/.gpp/certs/msg.txt
# MSGSIG=$HOME/.gpp/certs/msg.sig
# GENKEYCRTSCRIPT=${HOME}/.gpp/certs/gen_ca_keycrt.sh
KEYPEM=$CUR_DIR/ca_key.pem
PUBPEM=$CUR_DIR/ca_pubkey.pem
CRTPEM=$CUR_DIR/ca_crt.pem
MSGTXT=${CUR_DIR}/msg.txt
MSGSIG=${CUR_DIR}/msg.sig
GENKEYCRTSCRIPT=${CUR_DIR}/gen_ca_keycrt.sh
